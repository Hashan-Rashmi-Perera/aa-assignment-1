...
//        System.out.println("====End Set 2 Data 3 ===\n\n");
    ...
    private static RedBlackBST<Long, Integer> readAndInsert(File dataFile, int set)
            throws FileNotFoundException {
        RedBlackBST<Long, Integer> insertBST = new RedBlackBST<>();
    ...
    private static void mySearch(RedBlackBST<Long, Integer> st, File dataFile, int set)
            throws FileNotFoundException {
        Scanner myReader = new Scanner(dataFile);
        Integer value = 0;
    ...
    private static void myDelete(RedBlackBST<Long, Integer> st, File dataFile, int set)
            throws FileNotFoundException {
        Scanner myReader = new Scanner(dataFile);
        Integer value = 0;
